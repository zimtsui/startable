...
type StoppedAlias = Stopped;
type UnstoppedAlias = Unstopped;
type StartingAlias = Starting;
type StartedAlias = Starting;
type UnstartedAlias = Unstarted;
type StoppingAlias = Stopping;


export namespace State {
	export const Stopped = StoppedAlias;
	export const Unstopped = UnstoppedAlias;
	export const Starting = StartingAlias;
	export const Started = StartedAlias;
	export const Unstarted = UnstartedAlias;
	export const Stopping = StoppingAlias;
	export type Stopped = StoppedAlias;
	export type Unstopped = UnstoppedAlias;
	export type Starting = StartingAlias;
	export type Started = StartedAlias;
	export type Unstarted = UnstartedAlias;
	export type Stopping = StoppingAlias;
}
